...
function About() {
    return(
        <div className={`flex-col content`}>
            ...
            show off to my friends. Fast forward a couple years and I’m 
            getting ready to graduate University of Arizona’s Full Stack 
            Web Developement Bootcamp. I’ve learned about many essential 
